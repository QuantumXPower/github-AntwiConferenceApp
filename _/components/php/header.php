<div class="content row">
	<div class="col-lg-12">
		<header class = "clearfix">
			<section id="branding">
			<a href = "index.php"><img src="images/misc/ralogo_monogram.png" alt="Logo fox Roux Conference"> </a>
			</section><!--branding -->
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
							...
							<li class="divider"></li>
							<li><a tabindex="-1" href="artists.php#Barot Bellingham"> Barot Bellingham</a></li>
							...
							<li><a tabindex="-1" href="artists.php#Lorenzon_Garcia">Lorenzon Garcia</a></li>
							<li><a tabindex="-1" href="artists.php#Hillary Goldwynn">Hillary Goldwynn</a></li>
							<li><a tabindex="-1" href="artists.php#Hassum_Harrod">Hassum Harrod</a></li>
							<li><a tabindex="-1" href="artists.php#Jennifer_Jeronme">Jennifer Jeronme</a></li>
